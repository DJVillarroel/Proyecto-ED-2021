 ...
 * Interface Map
 * 
 * @author Cátedra de Estructuras de Datos, Departamento de Cs. e Ing. de la
 *         Computación, UNS.
 */
...
public interface Map<K, V> {
	...
	/**
	 * Busca una entrada con clave igual a una clave dada y devuelve el valor
	 * asociado, si no existe retorna nulo.
	 * 
	...
	/**
	 * Si el mapeo no tiene una entrada con clave key, inserta una entrada con clave
	 * key y valor value en el mapeo y devuelve null. Si el mapeo ya tiene una
	 * entrada con clave key, entonces remplaza su valor y retorna el viejo valor.
	 * 
	...
	/**
	 * Remueve la entrada con la clave dada en el mapeo y devuelve su valor, o nulo
